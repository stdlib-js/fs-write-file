...
tape( 'the command-line interface writes data received from `stdin` to a file', opts, function test( t ) {
	var expected;
	var opts;
	var cmd;
...
tape( 'if an error is encountered when writing to file, the command-line interface prints an error and sets a non-zero exit code', opts, function test( t ) {
	var script;
	var opts;
	var cmd;
...
// TODO: add tests for each CLI optional flag

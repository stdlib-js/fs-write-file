...
```javascript
writeFile = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/fs-write-file@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/fs-write-file@umd/bundle.js"></script>
```
